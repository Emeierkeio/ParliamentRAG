...
export const config = {
  ...
  politicalGroups: {
    ...
    "AZIONE-POPOLARI EUROPEISTI RIFORMATORI-RENEW EUROPE": { color: "#2A3271", label: "Azione - Popolari Europeisti Riformatori - Renew Europe" },
    ...
    "Azione": { color: "#2A3271", label: "Azione - Popolari Europeisti Riformatori - Renew Europe" },
